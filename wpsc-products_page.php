	  ...
	  <?php else:?>
			...
			<ul class="wpsc_categories">
				...
				<?php wpsc_start_category_query(array('category_group'=>get_option('wpsc_default_category'), 'show_thumbnails'=> get_option('show_category_thumbnails'))); ?>
						<li class="<?php wpsc_print_category_name(); ?>">
							<a href="<?php wpsc_print_category_url();?>" class="wpsc_category_link <?php wpsc_print_category_classes_section(); ?>" title="<?php wpsc_print_category_name(); ?>"><?php wpsc_print_category_image(148, 148); ?></a>

							<h2 class="cattitle"><a href="<?php wpsc_print_category_url();?>" class="wpsc_category_link <?php wpsc_print_category_classes_section(); ?>" title="<?php wpsc_print_category_name(); ?>"><?php wpsc_print_category_name(); ?></a></h2>
...
<!-- title was here -->
				...
				<h2 class="prodtitle entry-title">
                        ...
                        <div class="cb_product_options"><fieldset><legend><?php _e('Product Options', 'wpsc'); ?></legend>
                        ...
                        </fieldset></div><!--close cb_product_options-->
						<?php } ?>
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
                            	<div class="cb_quantity"><fieldset><legend style="display:none;"><?php _e('Quantity', 'wpsc'); ?></legend>
								<div class="wpsc_quantity_update" style="width:100px;">
                                <?php /*<label for="wpsc_quantity_update_<?php echo wpsc_the_product_id(); ?>"><?php _e('Quantity', 'wpsc'); ?>:</label>*/ ?>
								Qty&nbsp;<input type="text" id="wpsc_quantity_update_<?php echo wpsc_the_product_id(); ?>" name="wpsc_quantity_update" size="2" value="1" />
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									...
									<?php if(wpsc_show_pnp()) : ?>
										<p class="pricedisplay shipping"><?php _e('Shipping', 'wpsc'); ?>:<span class="pp_price"><?php echo wpsc_product_postage_and_packaging(); ?></span></p>
									<?php endif; ?>
								<?php endif; ?>
							</div><!--close wpsc_product_price-->
<div class="cb_unit"><?php if( function_exists( 'wpsc_the_custom_fields' ) ) wpsc_the_custom_fields( 'slug=unit' ); ?></div>
		...
		<?php if(wpsc_product_count() == 0):?>
			<h3><?php  _e('There are no products at this time in this group. Please contact us for availability.', 'wpsc'); ?></h3>
		<?php endif ; ?>
