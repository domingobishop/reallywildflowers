...
if(wpsc_cart_item_count() < 1) :
   _e('Oops, there is nothing in your cart. <a href="http://shop.reallywildflowers.co.uk/">Please visit our shop</a>', 'wpsc') . '<a href="http://shop.reallywildflowers.co.uk/">Please visit our shop</a>';
   return;
endif;
?>
<div id="checkout_page_container">
<h3><?php _e('Please review your order', 'wpsc'); ?> or <a href="<?php echo site_url(); ?>">Continue Shopping</a></h3>
<table class="checkout_cart">
   ...
   <?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); ?>
      ...
      <tr class="product_row product_row_<?php echo wpsc_the_cart_item_key(); ?> <?php echo $alt_class;?>">
         ...
         <td class="wpsc_product_quantity wpsc_product_quantity_<?php echo wpsc_the_cart_item_key(); ?>">
            ...
            <td><?php echo wpsc_cart_single_item_price(); ?></td> <!--wpsc_product_price -->
         <td class="wpsc_product_price_<?php echo wpsc_the_cart_item_key(); ?>"><span class="pricedisplay"><?php echo wpsc_cart_item_price(); ?></span></td>
  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   ?>
<!--      <table class="wpsc_checkout_table productcart">
         <tr class="total_price total_tax">
            <td class="wpsc_tax_totals">
...
<div class="cartformbox">

	<?php if ( wpsc_show_user_login_form() && !is_user_logged_in() ): ?>
			<!-- <p style="padding-top:7px;"><?php _e('You must sign in or register with us to continue with your purchase. Please note that passwords must be a minimum of 8 characters long with at least a number and/or symbol (eg !@#$) included.', 'wpsc');?></p>
			<div class="wpsc_registration_form cb_reg_form">
				...
				<fieldset class='wpsc_registration_form'>
					...
					wp_login_form( $args );
					?>
					<div class="wpsc_signup_text"><?php _e('If you have bought from us before please sign in here to purchase.', 'wpsc');?><br>Forgotten your password? <a href="http://www.reallywildflowers.co.uk/wp-login.php?action=lostpassword">Reset your password.</a></div>
				</fieldset>
			</div> -->
    ...
    <?php if(wpsc_show_user_login_form()):
		...
		<div class="wpsc_registration_form cb_reg_form" style="margin-left:7%;">
        ...
        <div class="clear" style="margin-bottom:14px;border-top:1px solid #ccc;width:100%;"></div>
      ...
      <tr>
         ...
         <td>
            <select name='how_find_us'>
               ...
               <option value='Marketing postcard'><?php _e('Marketing postcard' , 'wpsc'); ?></option>
               <option value='Internet'><?php _e('Internet' , 'wpsc'); ?></option>
               <option value='Already a customer'><?php _e('Existing Customer' , 'wpsc'); ?></option>
            </select>
         </td>
      </tr>
      <?php endif; ?>
      ...
      <div class='wpsc_make_purchase'>
         <span>
            ...
            <?php endif; ?>
               ...
               <input type='submit' value='<?php _e('Purchase Now', 'wpsc');?>' class='make_purchase wpsc_buy_button' />
         </span>
      </div>

<div class='clear'></div>
</form>
</div><!--close cartformbox-->
</div>
