...
<div class="wpsc_additional_description">
...
<?php
                        ...
                        <div class="cb_product_option"><fieldset><legend><?php _e('Product Options', 'wpsc'); ?></legend>
                        ...
                        </fieldset></div><!--close cb_product_option-->
						<?php } ?>
						<?php /** the variation group HTML and loop ends here */?>

<div class="cb_quantity_price_add"><!--open cb_quantity_price_add-->
...
<input type="hidden" name="key" value="<?php echo wpsc_the_cart_item_key(); ?>"/>
							...
							<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								...
								<?php else : ?>
									<div class="soldout"><!--<?php _e('Sold out', 'wpsc'); ?>-->
										<p><a href="http://www.reallywildflowers.co.uk/about/product-enquiry/" class="product-enquiry-link">Enquire about this product</a></p>
									</div>
...
</div><!--open cb_quantity_price_add-->
