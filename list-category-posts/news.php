...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= '<div class="lcp_catlistitem">';
	...
	$lcp_display_output .= '<h3 class="lcp_catlisttitle">'.$this->get_post_title($single).'</h3>';
    ...
    /**
     * Post content - Example of how to use tag and class parameters:
     * This will produce:<div class="lcp_excerpt">The content</div> $lcp_display_output .= '<a href="' . get_permalink($single->ID).'">Read more</a>';
     */
    $lcp_display_output .= $this->get_excerpt($single, 'div', 'lcp_excerpt');
	

    //Close li tag
    $lcp_display_output .= '<div style="clear:both;"></div></div><hr style="clear: both; margin: 10px 0;" />';
endforeach;
